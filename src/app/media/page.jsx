...
const MediaPage = () => {
  const categories = ["All", "Digital", "Podcasts", "Shorts", "Articles"];
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <section className="mb-8 mt-8">
          ...
          {(activeFilter === "All" || activeFilter === "Digital") && (
            <div className="mt-10">
              <h2 className="text-2xl md:text-4xl font-semibold my-8">
                Digital
              </h2>
          ...
          {(activeFilter === "All" || activeFilter === "Podcasts") && (
            <div className="mt-10">
              <h3 className="text-2xl md:text-4xl font-semibold my-8">
                Podcasts
              </h3>
        ...
        {(activeFilter === "All" || activeFilter === "Articles") && (
          <section className="mt-10">
            <h2 className="text-2xl md:text-4xl font-semibold my-8">Print</h2>
