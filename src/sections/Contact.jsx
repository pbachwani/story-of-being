        ...
        <div className="grid lg:grid-cols-2 gap-10 items-end ">
          ...
          <div className="text-white/80 flex flex-col gap-10">
            ...
            <form
              ...
              disabled={submitting}
              className="md:hidden flex flex-col gap-6 backdrop-blur-md bg-white/5 p-6 md:p-8 rounded-2xl border border-white/10"
            >
          ...
          <div className="flex flex-col gap-4 max-md:mt-16">
            ...
            <form
              onSubmit={handleSubmit}
              disabled={submitting}
              className="max-md:hidden flex flex-col gap-6 backdrop-blur-md bg-white/5 p-6 md:p-8 rounded-2xl border border-white/10"
            >
              <h1 className="font-abril text-2xl md:text-3xl">
                Have a project in mind?
              </h1>
